    ...
    <div class="flex min-h-screen">
        ...
        <aside class="bg-gray-800 w-64 flex flex-col items-center py-6 space-y-6 relative slide-in">
            ...
            <nav class="flex flex-col items-center space-y-4 w-full px-6">
                <a href="{{ route('dashboard') }}" class="nav-link flex items-center space-x-3 bg-gray-700 rounded-full py-2 px-5 text-xs w-full text-center hover:bg-gray-600 transition btn-hover">
                    <i class="fas fa-tachometer-alt"></i> <span>Dashboard</span>
                </a>
                <a href="{{ route('stock-in') }}" class="nav-link flex items-center space-x-3 bg-gray-700 rounded-full py-2 px-5 text-xs w-full text-center hover:bg-gray-600 transition btn-hover">
                    <i class="fas fa-cart-plus"></i> <span>Stock In</span>
                </a>
                <a href="{{ route('sales') }}" class="nav-link flex items-center space-x-3 bg-gray-700 rounded-full py-2 px-5 text-xs w-full text-center hover:bg-gray-600 transition btn-hover">
                    <i class="fas fa-percent"></i> <span>Sales</span>
                </a>
                <a href="{{ route('inventory') }}" class="nav-link flex items-center space-x-3 bg-gray-700 rounded-full py-2 px-5 text-xs w-full text-center hover:bg-gray-600 transition btn-hover">
        ...
        <main class="flex-1 bg-gray-900 fade-in">
            <header class="bg-gray-800 flex items-center justify-between px-6 py-4">
                <form class="flex items-center bg-gray-700 rounded-full px-4 py-2 w-36 max-w-full" method="GET" action="{{ route('search') }}">
                    ...
                    <button class="pl-2 btn-hover" aria-label="Search">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button class="bg-orange-600 rounded-full p-2 flex items-center justify-center btn-hover" aria-label="User">
                        <i class="fas fa-user text-white text-sm"></i>
                    </button>

                    <div class="relative">
                        <button id="dropdownButton" class="text-white text-xl focus:outline-none" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-cogs"></i>
                        </button>
                        <div id="dropdownMenu" class="hidden absolute right-0 mt-2 w-48 bg-gray-800 rounded-md shadow-lg z-50" role="menu" aria-labelledby="dropdownButton">
            ...
            <div class="p-6">
                <h1 class="text-2xl font-bold text-white animate-pulse">Welcome to Your Dashboard</h1>
