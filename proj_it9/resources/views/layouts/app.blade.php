...
<head>
    ...
    <style>
        ...
        body {
            ...
            min-height: 100vh;
            background: linear-gradient(to right, rgb(36, 33, 33), rgb(150, 142, 142));
            /* Gradient background */
            color: #ffffff;
        ...
        footer {
            ...
            /* Light pink border for contrast */
            box-shadow: 0 -4px 8px rgba(0, 0, 0, 0.2);
            /* Subtle shadow for depth */
            font-size: 0.9rem;
        }
        ...
        @media (max-width: 768px) {
            ...
            a.navbar-brand {
                font-size: 1.5rem;
                /* Smaller brand size for mobile */
            }

            footer {
                font-size: 0.8rem;
                /* Smaller footer text for mobile */
            }
        }
    </style>
</head>
